...
<section class="sidebar">
	<ul class="sidebar-menu" data-widget="tree">
		...
		<?php if (__session('user_type') === 'student' && in_array('student_profile', __session('user_privileges'))) { ?>
			...
			<li class="<?=isset($student_presences) ? 'active':'';?>">
				<a href="<?=site_url('student_profile/presences');?>">
					<i class="fa fa-check-square-o"></i> <span>PRESENSI</span>
				</a>
			</li>
			<li class="<?=isset($posts) ? 'active':'';?>">
				<a href="<?=site_url('posts');?>">
		...
		<?php if (__session('user_type') === 'super_user' || __session('user_type') === 'administrator') { ?>
			<?php if (in_array('academic', __session('user_privileges'))) { ?>
				...
				<li class="treeview <?=isset($presences) || isset($teaching_agendas) || isset($attendance_list) ? 'active':'';?>">
					<a href="#"><i class="fa fa-sign-out"></i> Presensi & Agenda <i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li <?=isset($presences) ? 'class="active"':'';?>><a href="<?=site_url('academic/presences');?>"><i class="fa fa-sign-out"></i> Presensi Siswa</a></li>
						<li <?=isset($teaching_agendas) ? 'class="active"':'';?>><a href="<?=site_url('academic/presences/teaching_agendas');?>"><i class="fa fa-sign-out"></i> Agenda Mengajar</a></li>
						<li <?=isset($attendance_list) ? 'class="active"':'';?>><a href="<?=site_url('academic/attendance_list');?>"><i class="fa fa-sign-out"></i> Cetak Rekap Presensi</a></li>
					</ul>
				</li>
			</ul>
		</li>
			...
			<?php if (in_array('admission', __session('user_privileges'))) { ?>
				<li class="treeview <?=isset($admission) ? 'active':'';?>">
					...
					<ul class="treeview-menu">
						...
						<li <?=isset($student_grade_subjects) ? 'class="active"':'';?>><a href="<?=site_url('admission/student_grade_subjects');?>"><i class="fa fa-sign-out"></i> Master Mata Pelajaran Nilai Rapor</a></li>
						<li <?=isset($student_grades) ? 'class="active"':'';?>><a href="<?=site_url('admission/student_grades');?>"><i class="fa fa-sign-out"></i> Nilai Rapor Calon <?=__session('_student')?> Baru</a></li>
					</ul>
				</li>
				<li class="treeview <?=isset($exam_management) ? 'active':'';?>">
					<a href="#"><i class="fa fa-sign-out"></i> Ujian Tes Tulis <i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li <?=isset($buildings) ? 'class="active"':'';?>><a href="<?=site_url('admission/buildings');?>"><i class="fa fa-sign-out"></i> Master Gedung</a></li>
						<li <?=isset($exam_rooms) ? 'class="active"':'';?>><a href="<?=site_url('admission/exam_rooms');?>"><i class="fa fa-sign-out"></i> Ruang Ujian</a></li>
						<li <?=isset($exam_subjects) ? 'class="active"':'';?>><a href="<?=site_url('admission/exam_subjects');?>"><i class="fa fa-sign-out"></i> Mata Pelajaran Ujian</a></li>
						<li <?=isset($exam_schedules) ? 'class="active"':'';?>><a href="<?=site_url('admission/exam_schedules');?>"><i class="fa fa-sign-out"></i> Jadwal Ujian</a></li>
						<li <?=isset($exam_participants) ? 'class="active"':'';?>><a href="<?=site_url('admission/exam_participants');?>"><i class="fa fa-sign-out"></i> Ruang Peserta Ujian</a></li>
						<li <?=isset($exam_cards) ? 'class="active"':'';?>><a href="<?=site_url('admission/exam_cards');?>"><i class="fa fa-sign-out"></i> Cetak Kartu Ujian</a></li>
					</ul>
				</li>
			</ul>
		</li>
